...
#include <memory>
namespace TP2 { namespace net { struct IHttpClient; class IWebSocket; } }

namespace TP2::ex {
class SimExchangeAdapter final : public IExchange {
public:
    SimExchangeAdapter(std::shared_ptr<TP2::net::IHttpClient> http,
